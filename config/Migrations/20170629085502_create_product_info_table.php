...
class CreateProductInfoTable extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $product_info = $this->table('product_info', ['comment' => '商品情报']);
        $product_info
            ->addColumn('product_id', 'integer', ['limit' => 11, 'null' => false, 'comment' => 'FK.商品'])
            ->addColumn('label', 'text', ['limit' => MysqlAdapter::TEXT_REGULAR, 'null' => false, 'comment' => '标签'])
            ->addColumn('content', 'text', ['limit' => MysqlAdapter::TEXT_REGULAR, 'null' => false, 'comment' => '内容'])
