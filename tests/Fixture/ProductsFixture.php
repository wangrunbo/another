...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'description' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '商品说明', 'precision' => null],
        'introduction' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '管理者添加的商品描述', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'product_type_id' => 1,
            'sale_start_date' => '2017-07-04 11:38:10',
            'stock_flg' => 1,
