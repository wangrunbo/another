...
class AddressesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'label' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '地址标签', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'addresses_ibfk_2' => ['type' => 'foreign', 'columns' => ['modifier_id'], 'references' => ['administrators', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
